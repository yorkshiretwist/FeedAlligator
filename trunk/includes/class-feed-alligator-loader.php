...
class Feed_Alligator_Loader {
	...
	public function __construct() {
		...
		$feed_alligator_alligator_feed_item_cpt = new Feed_Alligator_Alligator_Feed_Item_CPT();
		$feed_alligator_alligator_feed_item_cpt->register();

		$feed_alligator_alligator_feed_cpt = new Feed_Alligator_Alligator_Feed_CPT();
		$feed_alligator_alligator_feed_cpt->register();
		$feed_alligator_alligator_feed_cpt->setup_meta_boxes( $this );
		$feed_alligator_alligator_feed_cpt->setup_columns( $this );
		$feed_alligator_alligator_feed_cpt->setup_save( $this );
